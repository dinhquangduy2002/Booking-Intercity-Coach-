                                ...
                                <div className="col-lg-3 col-md-6" key={acc.id}>
                                    <div className="team-item rounded overflow-hidden border">
                                        ...
                                        <div className="p-4 mt-3">
                                            ...
                                            <div className=""><i className="bi bi-person-vcard-fill me-3 text-trip"></i>{acc.username}</div>
                                            <div><i className="bi bi-telephone-fill me-3 text-trip"></i>{acc.phone}</div>
                                            <div><i className="bi bi-envelope-fill me-3 text-trip"></i>{acc.email}</div>
                                        </div>
                                    </div>
                                </div>
                            )
