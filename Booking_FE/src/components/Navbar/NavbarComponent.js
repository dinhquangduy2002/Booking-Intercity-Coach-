        ...
        <div className="container-fluid nav-bar py-2 mb-5 sticky-top">
            <nav className="navbar navbar-expand-lg navbar-light py-0 px-4">
                <Link to={"/"} className="navbar-brand d-flex align-items-center text-center">
                    <div className="me-1">
                        <img className="img-fluid" style={{width:'60px'}}  src="https://png.pngtree.com/png-clipart/20240614/original/pngtree-travel-bus-icons-tour-transport-or-public-transportation-service-vector-emblems-png-image_15321050.png" alt="Icon"/>
                    </div>
                    <h2 style={{color: "rgb(0,185,142)"}}>LUXURY CAR</h2>
                </Link>
