    ...
    const checkRole = () => {
        if (account.role.name === "ROLE_ADMIN") {
            ...
            return (
                <li className="px-3 py-2">
                    <NavLink to="/profile/rental-history"
                        ...
                        <span className="hide-menu">Lịch sử mua vé</span>
                    </NavLink>
                </li>
            )
        } else {
            return (
                <>
                    <li className="px-3 py-2">
                        <NavLink to="/profile/trips-owner-booking"
                                 className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
                    ...
                    <li className="px-3 py-2">
                        <NavLink to="/profile/trips-owner"
                                 className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
                    ...
                    <li className="px-3 py-2">
                        <NavLink to="/profile/trips-owner-revenue"
                                 className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
